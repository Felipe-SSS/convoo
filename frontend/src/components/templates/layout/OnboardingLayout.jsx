...
const OnboardingLayout = ({ 
  ...
  return (
    <div className={`min-h-screen bg-slate-50 relative overflow-hidden ${className}`}>
      ...
      {/* Hexágono Azul Escuro (direita inferior) */}
      <motion.div
        className="fixed opacity-50"
        style={{
          right: '1vw',
      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <div 
          className={`w-full ${cardWidth} ${cardHeight} bg-white/90 backdrop-blur-sm rounded-xl shadow-2xl no-scrollbar border border-slate-200 ${cardPadding} overflow-y-auto max-h-[900px]`}
        >
          {children}
        </div>
      </div>
